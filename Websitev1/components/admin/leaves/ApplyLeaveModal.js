      ...
      <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-100">
        <div className="px-8 py-6 border-b border-slate-50 flex justify-between items-center bg-slate-50/30">
          <div>
            ...
            <h2 className="text-2xl font-extrabold text-slate-800 tracking-tight">Apply <span className="text-green-600">Leave</span></h2>
            <p className="text-[11px] text-slate-400 font-medium">Coordinate time-off requests with automated balance tracking.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div>
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 pl-1">Target Employee <span className="text-rose-500">*</span></label>
            <select
              required
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 pl-1">Status</label>
              <select
          ...
          <div className="grid grid-cols-2 gap-5">
            <div>
              <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 pl-1">Start <span className="text-rose-500">*</span></label>
              <input
                type="date"
                required
            ...
            <div>
              <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 pl-1">End <span className="text-rose-500">*</span></label>
              <input
                type="date"
                required
                className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-xs font-bold text-slate-700 focus:ring-4 focus:ring-green-500/5 focus:border-green-500 outline-none transition-all shadow-sm"
          ...
          <div>
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 pl-1">Statement of Reason</label>
            <textarea
