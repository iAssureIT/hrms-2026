...
const AddHolidayPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire(
        "Error",
        err.response?.data?.error || "Failed to create holiday",
        "error",
      );
    } finally {
      setLoading(false);
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                        ...
                        >
                          ...
                          >
                            {formData.locations.includes(loc) ? (
                              ...
                              <span className="text-gray-300 opacity-0">
                                {icon}
                              </span>
                            )}
                          </div>
                  ...
                  <p className="mt-2 text-[10px] text-gray-400 italic font-normal">
                    Select one or more regions affected by this holiday.
                  </p>
                </div>
              </div>
