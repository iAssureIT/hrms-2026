...
const GenericTable = (props) => {
  ...
  const redirect = (action, uid) => {
    if (action === "view") {
      ...
      window.open("/viewUser/" + uid, '_blank', 'noopener,noreferrer');
    ...
    if (action === "approval") {
      ...
      window.open(tableObjects.buttonURL, '_blank', 'noopener,noreferrer');
    }
  };
            ...
            <div className="w-1/2">
              ...
              <div className="relative mt-2 rounded-md shadow-sm text-gray-500 w-full">
                ...
                <select
                  ...
                  className={`${
                    recsPerPage ? "stdSelectField" : "stdSelectField"
        ...
        <div className="table-responsive overflow-scroll mt-2">
          ...
          <table className="table-auto text-sm bottom border border-1 border-grayZero w-full dark:w-full">
            <thead className="text-xs border-2 border-grayZero uppercase bg-white dark:bg-white">
              <tr className=" bg-gray-100">
                <th className=" px-4 py-3 bg-white"> Sr. No</th>
                {tableHeading ? (
                  Object.entries(tableHeading).map(([key, value], i) => {
                    if (key === "actions") {
                      ...
                      return (
                        <th key={i} className="text-center bg-white">
                          {value}{" "}
                          <span
                            onClick={sortData}
                            id={key}
                      ...
                      return (
                        ...
                        >
                          ...
                          {tableHeading && tableHeading.actions ? (
                            <td className="flex gap-2 justify-center px-4 h-auto">
                              <MdOutlineEdit
          ...
          >
            ...
            <Modal.Body>
              <div className="modalBody">
                {/* {Swal.fire({ icon: "success" })} */}
                <h3 className="modalText">{tableObjects.titleMsg} are safe</h3>
                <div className="flex justify-center gap-4">
                  <button
                    className="modalSuccessBtn"
                    onClick={() => setDeleteFailModal(false)}
