                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end pb-1 border-b border-slate-100">
                        <div className="space-y-1">
                            ...
                            <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight pl-1">
                                Disposal <span className="text-[#3c8dbc] font-black">Approval List</span>
                            </h1>
                        </div>
                        <div className="flex items-center gap-2 pt-4 md:pt-0 mb-1">
                            <span className="text-[10px] font-black text-[#dd4b39] bg-red-50 px-3 py-1 rounded border border-red-100 uppercase tracking-widest">
                                ...
                                <div className="bg-[#0f172a] rounded-xl p-8 text-white relative overflow-hidden shadow-xl">
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
                                            ...
                                            <h3 className="text-xs font-black uppercase tracking-widest">Enterprise Authorization Decision</h3>
                                        </div>
