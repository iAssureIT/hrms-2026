...
import { MdCallMade, MdCallReceived, MdHistory, MdWatchLater, MdDescription } from "react-icons/md";
import {
    HiTicket,
    HiClock,
    HiXCircle,
...
const GatePassList = () => {
    ...
    const tableObjects = {
        tableName: "Gate Pass Management",
        ...
        <section className="section p-6 md:p-10 bg-white min-h-screen">
            <div className="max-w-[1440px] mx-auto">
                ...
                <div className="bg-white">
                    ...
                    >
                        <Tooltip content="Click here to see the filters" placement="bottom" className="bg-green">
