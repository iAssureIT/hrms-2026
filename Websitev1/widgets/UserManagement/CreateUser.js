...
//                   ?
//                     (window.location.href = "/" + loggedInRole + "/utilization-management/utilization-list")
...
const CreateUserForm = (props) => {
  ...
  <button
    ...
    className={`stdSelectField text-left ${
      centerName ? "selectOption" : "text-gray-400"
    }`}
  >
    {centerName ? centerName : "-- Select Location --"}
