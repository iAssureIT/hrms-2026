...
const UserProfile = (props) => {
  ...
  return (
    <section className="pt-8 md:pt-16 flex justify-center">
      <div className="box border-2 rounded-md shadow-md w-11/12 md:w-3/5">
        ...
        <div className="flex justify-center">
          <form className="mx-4 md:mx-10 lg:mx-auto w-full lg:w-3/4 mt-8 pb-8">
            <div className="grid gap-4 mb-2 grid-cols-1 max-w-5xl">
              <div className="mb-4">
                <div className="text-center heading text-lg md:text-xl font-bold">
                  {loading ? (
                    <FaSpinner className="animate-spin inline-flex mx-2 text-Green" />
                  ) : firstName && lastName ? (
                    `${firstName} ${lastName}`
            ...
            <div className="grid gap-4 mt-5 mb-2 grid-cols-1 md:grid-cols-2 max-w-5xl">
              <div className="mb-4 text-center">
                <label htmlFor="email" className="inputLabel block mb-1">
                  Email
                </label>
              ...
              <div className="mb-4 text-center">
                <label htmlFor="mobile" className="inputLabel block mb-1">
                  Mobile No
                </label>
                <div>
                  {loading ? (
            ...
            <div className="grid gap-4 mt-6 md:mt-10 mb-2 grid-cols-1 md:grid-cols-2 max-w-5xl">
              <div className="mb-4 text-center">
                <label htmlFor="location" className="inputLabel block mb-1">
                  Location
                </label>
                <div>
                  {loading ? (
              ...
              <div className="mb-4 text-center">
                <label htmlFor="role" className="inputLabel block mb-1">
                  Role
                </label>
