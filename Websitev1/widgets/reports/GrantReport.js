...
function ExternalGrantList() {
  ...
  const [fundingAgencyDropdownOpen, setFundingAgencyDropdownOpen] =
    useState(false);
      ...
      <div className="border-none sm:border md:border-2 border-gray-100 !rounded-none md:!rounded-md !shadow-none md:!shadow-md">
        ...
        <div className="uppercase text-xl font-semibold">
          <div className="border-b-2 border-gray-300 flex justify-between">
            <h1 className="heading h-auto content-center">Grant Report</h1>
          </div>
        </div>
          ...
          <div className="mt-4 mb-0 lg:mb-5 w-full grid lg:grid-cols-4 md:grid-cols-2 grid-cols-2 gap-2">
            ...
            <div className="">
              ...
              <div className="relative mt-2 rounded-md shadow-sm text-gray-500">
                ...
                {fundingAgencyDropdownOpen && (
                  <div className="absolute z-40 w-full bg-white border rounded-md shadow-md mt-1 max-h-48 overflow-y-auto overflow-x-hidden">
                    <div
                      onClick={() => {
                    ...
                    {fundingAgencyList?.map((fundingAgency, i) => (
                      <div
                        ...
                        onClick={() => {
                          setFundingAgencyName(
                            `${fundingAgency._id}|${fundingAgency.fundingAgencyName}`,
                          );
                          setFundingAgencyDropdownOpen(false);
                        }}
