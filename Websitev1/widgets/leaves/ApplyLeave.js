      ...
      <div className="mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <div className="flex items-baseline gap-3">
            <h1 className="text-2xl font-normal text-gray-800 tracking-tight">Apply Leave</h1>
            <span className="text-sm font-light text-gray-500">Submit Application</span>
          </div>
        ...
        <div className="max-w-2xl mx-auto bg-white border-t-[3px] border-[#00a65a] shadow-sm overflow-hidden mt-6">
          <div className="px-5 py-3 border-b border-gray-100 bg-white">
            <h3 className="text-sm font-bold text-gray-800 uppercase tracking-tight">Application Form</h3>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-2">Target Employee <span className="text-red-500">*</span></label>
                <select
                  required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-2">Start Date <span className="text-red-500">*</span></label>
                <input
                  type="date"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-gray-700 mb-2">End Date <span className="text-red-500">*</span></label>
                <input
                  type="date"
                  required
                  className="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs font-normal text-gray-700 focus:outline-none focus:border-[#3c8dbc]"
            ...
            {/* Reason */}
            <div>
              <label className="block text-xs font-bold text-gray-700 mb-2">Statement of Reason</label>
              <textarea
