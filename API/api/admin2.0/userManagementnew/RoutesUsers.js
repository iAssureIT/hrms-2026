...
router.patch("/patch/user/:ID", UserController.update_user_details);
router.post("/post/user", UserController.add_user_details);
// router.post("/post/list", UserController.post_list_users);

router.post("/post/list", UserController.post_list_users_filter);

router.post(
  "/post/list/:recsPerPage/:pageNumber",
  UserController.list_users_recsPerPage
);
...
router.post(
  "/post/list/statusrole/:role/:status",
  UserController.fetch_users_status_roles
);
...
router.patch(
  "/patch/profile/:ID",
  UserController.user_update_name_mobile_profile
);
router.patch("/patch/status", UserController.user_update_many_status);
router.patch("/patch/roles", UserController.user_update_many_role);
...
router.post(
  "/get/list/companies/:company",
  UserController.fetch_users_Companies
);

router.post(
  "/get/list/rolecompany/:role/:company",
  UserController.fetch_users_company_roles
);

router.post(
  "/get/list/statuscompany/:company/:status",
  UserController.fetch_users_company_status
);

router.post(
  "/get/list/statuscompanyrole/:company/:status/:role",
  UserController.fetch_users_company_status_role
);
...
router.patch(
  "/patch/change_password_withoutotp/id/:ID",
  UserController.user_update_password_withoutotp_ID
);

router.get("/get/:ID", UserController.fetch_user_ID);
router.get("/get/user_logdetails/:ID", UserController.fetch_user_loginDetails);
...
router.get("/get/list/user", UserController.getUsersList);
...
router.get("/get/user/count/:user_id", UserController.countUsers); //for dashboard
...
router.patch(
  "/patch/complete-user-profile/:ID",
  UserController.update_complete_user_profile
);

router.post(
  "/get/list/user/seniorManager",
  UserController.getSeniorManagerList
);

router.post(
  "/get/list/user/accountPerson",
  UserController.getAccountPersonList
);

router.post("/get/list/center", UserController.getCenterInchargeList);
