...
const vendorSubCategorySchema = mongoose.Schema({
    ...
    dropdown_id: { type: mongoose.Schema.Types.ObjectId, ref: "assetcategorymasters" },
...
module.exports = mongoose.model('vendorsubcategorymasters', vendorSubCategorySchema);
